...
class TreeNode(object):
    ...
    def return_moves_prob(self, board, moves, color):
        """
        Expands tree by creating new children.
        return probs for all moves
        """
        gammas_sum = 0.0
        ...
        if len(Features_weight) != 0 and gammas_sum != 0.0:
            for move in moves:
                ...
                # record normalized prob for move and save to result dict
                result[move]=format(self._children[move]._prob_simple_feature,'.5f')
